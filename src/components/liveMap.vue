  ...
  <div class="hello">
    <div style="text-align: center; ">
      ...
      <div v-show="loading" style="background: #fff;width: 1750px; height: 800px;z-index: 998;position:absolute;opacity: 0.5;">
        <div v-show="loading" style="position:absolute;z-index: 999; width: 1750px;height:550px;opacity: 0.8;background: url(../../static/timg.gif) no-repeat center center fixed;"></div>
      </div>
      <div id="map1" style="width: 800px;height:550px;display:inline-block"></div>
      <div id="map2" style="width: 800px;height:550px;display:inline-block"></div>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      getMapInfo () {
        ...
        this.$http.get('http://10.0.10.253:8000/api/abnormalL',{params: {
          qdate: this.qdate,
          qdq: this.qdq
        }}).then(response => {
        ...
        this.$http.get('http://10.0.10.253:8000/api/liveL',{params: {
          qdate: this.qdate,
          qdq: this.qdq
        }}).then(response => {
            console.log(response);
